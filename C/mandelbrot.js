module.exports = async () => {
  ...
  const res = await fetch('C/mandelbrot.wasm');
  ...
  return {
    ...
    name: 'WebAssembly from C',
    description: 'This implementation uses Emscripten to compile the C version of the mandelbrot to wasm.'
  };
};
